...
export default async function TestimonyPage() {
  ...
  return (
    <>
      <PageHeader
        title={testimonyContent.heading}
        crumbLabel="Share a Testimony"
        crumbHref="/testimony"
        eyebrow="Connect"
        image="/images/testimonies.jpg"
        imageAlt="GCIC members sharing testimonies"
      />
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 space-y-6">
              {testimonies.map((t) => (
                <blockquote
                  key={t._id}
                  className="rounded-[var(--radius-media)] border border-sand-200 bg-ivory p-6 shadow-warm"
                >
