/** Recovered copy — see GCIC-WEBSITE-BUILD-PROMPT.md §2.4. */

export const leadership = {
  name: "Pastor & Pastor Mrs Matthew Morakinyo",
  scriptureRef: "Galatians 3:28",
  scriptureText:
    "There is neither Jew nor Greek, there is neither slave nor free, there is no male and female, for you are all one in Christ Jesus.",
  intro:
    "At GCIC, our belief is that we are all one in the body of Christ. With our mandate of Deliverance, Rescue, Restoration and Mobile Fire, whether you are joining us in person or online, we invite you to experience our services and be a part of the GCIC family. As you do so with an open heart to meet with God, we pray that you have a divine encounter with God.",
  callingHeading: "From the Pastor's Prayer Room: God's Calling",
  calling: [
